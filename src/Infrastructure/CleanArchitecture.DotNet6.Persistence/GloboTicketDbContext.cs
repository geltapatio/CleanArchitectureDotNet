...
namespace CleanArchitecture.DotNet6.Persistence
{
    public class CleanArchitectureDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            SeedCategory(modelBuilder, concertGuid, musicalGuid, conferenceGuid);
            SeedEvent(modelBuilder, musicalGuid, conferenceGuid, concertGuid);
        ...
        private static void SeedEvent(ModelBuilder modelBuilder, Guid musicalGuid, Guid conferenceGuid, Guid concertGuid)
        {
        ...
        private static void SeedCategory(ModelBuilder modelBuilder, Guid concertGuid, Guid musicalGuid, Guid conferenceGuid)
        {
